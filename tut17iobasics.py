...
f=open("ved.txt") # create 1st txt file , whenever you open the line you have to close it
...
print(f.read(5)) #f= file pointer
"""
print( f.readline(),end="") #readline will read single single line whereas readlines or read() will read all the lines in one time
print( f.readline())
print( f.readline())
"""
f.close()
